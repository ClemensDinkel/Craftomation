...
export const PRODUCTION_GOOD_DEFINITIONS: ProductionGoodDefinition[] = [
  ...
  { id: 'workbench',     tier: 1, bonusType: 'craft_speed',        bonusValue: 25, module: 'manufacturing', wearUses: 8 },
  ...
  { id: 'conveyor',      tier: 2, bonusType: 'craft_speed',        bonusValue: 40, module: 'manufacturing', wearUses: 12 },
  ...
  { id: 'assembly_line', tier: 3, bonusType: 'craft_speed',        bonusValue: 55, module: 'manufacturing', wearUses: 16 },
  ...
  { id: 'nano_forge',    tier: 4, bonusType: 'craft_speed',        bonusValue: 60, module: 'manufacturing', wearUses: 24 },
